...
const AudioDetection = () => {
  ...
  return (
    ...
    {/* <Navbar /> */}
    <h2 className="text-3xl font-bold text-center my-6">Audio Detection</h2>
    <div className="flex flex-col items-center justify-center">
      <input type="file" accept="audio/*" onChange={handleFileChange} className="hidden" id="audioUpload" />
      <label htmlFor="audioUpload" className="bg-blue-500 px-6 py-3 rounded-lg text-white cursor-pointer">Choose Audio File</label>
      {audioFile && (
